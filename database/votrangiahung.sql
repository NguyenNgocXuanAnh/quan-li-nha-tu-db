...
GRANT SELECT, INSERT, UPDATE ON KHUVUC TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON PHONGGIAM TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON LICHSUCHUYENPHONG TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON VIPHAMKYLUAT TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON THAMNUOI TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON LICHTHAMNUOI TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON CONGVIEC TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON CAITAO TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON BANAN TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON TOIDANH TO qn_thuong_user;
GRANT SELECT, INSERT, UPDATE ON BANAN_TOIDANH TO qn_thuong_user;

GRANT SELECT ON QUANNGUC TO qn_thuong_user;

REVOKE SELECT ON QUANNGUC FROM qn_thuong_user;

DENY SELECT ON TAIKHOAN TO qn_thuong_user;